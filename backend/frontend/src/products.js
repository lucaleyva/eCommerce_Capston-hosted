const products = [
    {
        '_id': '1',
        'name': 'Agile Software Development: From Beginner to Practitioner',
    ...
    {
        '_id': '2',
        'name': 'Scrum: From Beginner to Practitioner',
    ...
    {
        '_id': '3',
        'name': 'Lean: From Beginner to Practitioner',
    ...
    {
        '_id': '4',
        'name': 'Applied Systems Thinking: From Beginner to Practitioner',
    ...
    {
        '_id': '5',
        'name': 'Kanban: From Beginner to Practitioner',
